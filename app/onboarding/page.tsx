...
export default function Onboarding() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Add your knowledge",
    },
    {
      number: 3,
            ...
            <div className="mt-12 flex gap-4">
              ...
              {currentStep === 6 ? (
                <Button
                  ...
                  asChild
                >
                  <Link href="/dashboard">Complete & Go to Dashboard</Link>
                </Button>
              ) : (
                <Button
                  className="flex-1 bg-gradient-primary hover:opacity-90"
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
        <p className="text-sm text-muted-foreground">
          ℹ️ This information helps your digital twin understand your background
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Train your twin with your knowledge
        </p>
      </div>
      ...
      <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
        <p className="text-sm text-muted-foreground">
          ℹ️ Your twin uses this knowledge to provide accurate responses. You
...
function Step3({ data, setData }: any) {
  ...
  return (
    <div className="space-y-6">
                  ...
                  setData({
                    ...
                    persona: {
                      ...
                      personality: data.persona.personality.includes(trait)
                        ? data.persona.personality.filter(
                            (t: string) => t !== trait,
                          )
      ...
      <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
        <p className="text-sm text-muted-foreground">
          ℹ️ These traits shape how your twin responds to interactions. You can
          adjust them anytime.
        </p>
      </div>
    </div>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Clone your voice for authentic interactions
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="border-2 border-dashed border-border rounded-lg p-8 text-center cursor-pointer hover:border-primary/50 transition-colors">
            <p className="text-muted-foreground">
              🎙️ Drag and drop audio or click to upload
            </p>
            <p className="text-xs text-muted-foreground mt-2">
      ...
      <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
        <p className="text-sm text-muted-foreground">
          ℹ️ Your voice sample will be cloned using AI technology. The quality
          of the sample affects accuracy.
        </p>
      </div>
    </div>
  );
...
function Step5({ data, setData }: any) {
  return (
    <div className="space-y-6">
          ...
          <div className="space-y-2">
            {[
              ...
              },
              {
                ...
                description: "Nuanced and detailed responses",
              },
              {
                id: "gemini",
                name: "Google Gemini",
      ...
      <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
        <p className="text-sm text-muted-foreground">
          ℹ️ You can change your AI provider anytime. Different providers have
          different strengths.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        >
          <div>
            ...
            <div className="text-sm text-muted-foreground">
              Allow others to find your twin
            </div>
          </div>
          <div
      ...
      <div className="p-4 rounded-lg bg-card border border-border space-y-3">
        ...
        <p className="text-sm text-muted-foreground mt-4">
          Click "Complete & Go to Dashboard" to start using your twin!
        </p>
      </div>

      <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
        <p className="text-sm text-muted-foreground">
          ℹ️ Your twin will be available immediately. You can customize it
